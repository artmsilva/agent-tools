...
| `pi-drydock` | [`packages/pi-drydock`](./packages/pi-drydock) | Independent Apple `container` sandbox for Pi tools; validated isolation spike with Davit as optional operator UI |
