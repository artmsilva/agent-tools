...
| `pi-drydock` | [`packages/pi-drydock`](./packages/pi-drydock) | Experimental `drydock_bash` tool using isolated Apple containers and reviewable patch export; Davit remains optional |
